        ...
        <div className="banner-horizental w-full h-full">
          ...
          >
            {slides.map((slide, index) => (
              <SwiperSlide
                key={slide.id}
                className="relative flex justify-center text-left flex-col overflow-hidden"
              >
                <div
                  className="slider-inner bg-black h-screen relative"
                ...
                >
                  ...
                  >
                    <div className="title-area">
                      ...
                      <a
                        href="#"
                        className="title text-white text-6xl md:text-7xl lg:text-8xl xl:text-8vw font-inter font-black leading-tight uppercase mb-12 -ml-3 no-underline"
                      >
                        {slide.title}
                      </a>
                    </div>
                    ...
                    <div className="creative-btn--wrap">
                      <a
                        className="creative-slide--btn text-white ml-4 text-2xl transition-all duration-300 font-normal inline-flex relative whitespace-nowrap no-underline justify-center items-center cursor-pointer user-select-none outline-none hover:ml-9"
                        role="button"
                        href="#0"
                      >
            ...
            <div className="swiper-button-wrapper creative-button--wrapper">
              <div
                className="swiper-button-next absolute bottom-5 top-auto scale-100 transition-all duration-400 bg-transparent backdrop-blur-xl h-20 w-20 rounded-full flex items-center justify-center hover:bg-white/5 cursor-pointer right-12 z-10"
                tabIndex={0}
                role="button"
              ...
              <div
                className="swiper-button-prev absolute bottom-5 top-auto scale-100 transition-all duration-400 bg-transparent backdrop-blur-xl h-20 w-20 rounded-full flex items-center justify-center hover:bg-white/5 cursor-pointer left-12 z-10"
                tabIndex={0}
                role="button"
            ...
            <div className="slider-pagination-area flex items-center justify-center absolute top-auto right-auto bottom-20 left-1/2 -translate-x-1/2 w-80 md:w-[500px] z-1">
              <h5 className="slide-range one absolute -left-12 text-white text-lg font-medium leading-none">
                01
              </h5>
              <div className="swiper-pagination swiper-pagination-progressbar swiper-pagination-horizontal w-80 md:w-[500px]"></div>
              <h5 className="slide-range three absolute -right-12 text-white text-lg font-medium leading-none">
                03
              </h5>
            </div>
          </Swiper>
